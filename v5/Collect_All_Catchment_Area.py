...
def gen_zip_file(cancer_center_name_abb, catchment_area_df, data_dictionary):
    ...
    dd.to_csv(ca_name + '_cif_variable_codebook_' + today + '.csv', encoding='utf-8', index=False)
...
if __name__ == '__main__':
    ...
    "ca_file_path": "all_current2024.csv",
    ...
    ca_path = glob('*/all_current2024.csv')[0] #change all_counties in pull_data when acquiring Puerto Rico
